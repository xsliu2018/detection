$(function () {
    $("#jqGrid").jqGrid({
        ...
        datatype: "json",
        colModel: [
            {label: 'id', name: 'linkId', index: 'linkId', width: 50, key: true, hidden: true, align: 'center'},
            {label: '网站名称', name: 'linkName', index: 'linkName', width: 100, align: 'center'},
            {label: '网站链接', name: 'linkUrl', index: 'linkUrl', width: 120, align: 'center'},
            {label: '网站描述', name: 'linkDescription', index: 'linkDescription', width: 120, align: 'center'},
            {label: '排序值', name: 'linkRank', index: 'linkRank', width: 30, align: 'center',},
            {label: '添加时间', name: 'createTime', index: 'createTime', width: 100 , align: 'center',}
        ],
        height: 560,
        rowNum: 10,
        rowList: [10, 20, 50],
